...
export const Dashboard = ({ message }:{message: any}) => {
        ...
        <>
            <div className='main-wrap'>
                ...
                <div className='column'>
                    <div style={{ minHeight: '40%' }} className='panel-block'>
                        <Accelerometer
                ...
                {/* center column */}
                <div style={{ justifyContent: 'space-between' }} className='column'>
                    <div>
                        <Tach
                            outerRadius={90}
                            innerRadius={90}
                            startAngle={0}
                            rpmWidth={ (data ? data.CurrentEngineRpm / data.EngineMaxRpm : 0) * 100}
                            endAngle={
                                data
